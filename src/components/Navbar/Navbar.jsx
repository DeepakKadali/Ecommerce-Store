    ...
    <>
      ...
      <div className="flex justify-around items-center">
        ...
        <div className="flex flex-row items-center">
          ...
          >
            {totalAmount > 0 ? (
              <span className="rouded-full bg-dray-400 font-inter test-sm mr-1 px-2">
                {totalAmount}
              </span>
            ) : (
              <svg
            ...
            <div>{open && <Cart open={open} setOpen={setOpen}></Cart>}</div>
          </div>
      ...
      <div className="flex bg-black p-4 w-fill justify-around">
